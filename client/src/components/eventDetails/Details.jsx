            ...
            <div className="detailsContainer">
              <div className="detailsSliderContainer">
                ...
                <div className="needToKnow">
                  ...
                  <ul>
                    <li>
                      <i className="fa-solid fa-check"></i> Your e-ticket will
                      be sent to you via e-mail and sms.
                    </li>
                    <li>
                    ...
                    <li>
                      <i className="fa-solid fa-check"></i> After the start of
                      the game, no spectators will be allowed in the hall.
                    </li>
                    <li>
                      <i className="fa-solid fa-check"></i> Ticket control will
                      be done at the entrance of the event, you must show your
              ...
              <div className="details">
                ...
                <div className="location">
                  <h2>Place</h2>
                  <p className="place">{q.location.name}</p>
                  <p className="address">{q.location.address}</p>
                  <div style={{ width: "100%", height: "350px" }}>
                    {/* <iframe
                      ...
                      allowFullScreen
                    ></iframe> */}
                    <EventMap mapLink={q.location.mapLink} />
                  </div>
                </div>
              </div>
            </div>
